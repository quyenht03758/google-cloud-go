...
const file_google_spanner_v1_result_set_proto_rawDesc = "" +
	"\n" +
	"\"google/spanner/v1/result_set.proto\x12\x11google.spanner.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a google/spanner/v1/location.proto\x1a\"google/spanner/v1/query_plan.proto\x1a#google/spanner/v1/transaction.proto\x1a\x1cgoogle/spanner/v1/type.proto\"\x99\x02\n" +
	"\tResultSet\x12@\n" +
	...
	"\x0fprecommit_token\x18\x05 \x01(\v23.google.spanner.v1.MultiplexedSessionPrecommitTokenB\x03\xe0A\x01R\x0eprecommitToken\"\xc4\x03\n" +
	...
	"\x04last\x18\t \x01(\bB\x03\xe0A\x01R\x04last\x12A\n" +
	"\fcache_update\x18c \x01(\v2\x1e.google.spanner.v1.CacheUpdateR\vcacheUpdate\"\xe3\x01\n" +
