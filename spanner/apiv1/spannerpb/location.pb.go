...
const file_google_spanner_v1_location_proto_rawDesc = "" +
	"\n" +
	" google/spanner/v1/location.proto\x12\x11google.spanner.v1\x1a\x1cgoogle/spanner/v1/type.proto\"\x99\x01\n" +
	"\x05Range\x12\x1b\n" +
	...
	"generation\"\x91\x01\n" +
	"\x05Group\x12\x1b\n" +
	"\tgroup_uid\x18\x01 \x01(\x04R\bgroupUid\x12\x1f\n" +
	"\vtablet_uids\x18\x02 \x03(\x04R\n" +
	"tabletUids\x12*\n" +
	"\x11leader_tablet_uid\x18\x03 \x01(\x04R\x0fleaderTabletUid\x12\x1e\n" +
	"\n" +
	...
	"\x04part\x18\x04 \x03(\v2!.google.spanner.v1.KeyRecipe.PartR\x04part\x1a\xd4\x02\n" +
	"\x04Part\x12\x10\n" +
	"\x03tag\x18\x01 \x01(\x05R\x03tag\x12=\n" +
	...
	"\x04type\x18\x04 \x01(\v2\x17.google.spanner.v1.TypeR\x04type\x12\x1e\n" +
	"\n" +
	"identifier\x18\x05 \x03(\tR\n" +
	"identifier\"&\n" +
	"\x05Order\x12\r\n" +
	...
	"\n" +
	"NULLS_LAST\x10\x01\x12\f\n" +
	"\bNOT_NULL\x10\x02B\b\n" +
	"\x06target\"o\n" +
	"\n" +
	"RecipeList\x12+\n" +
	"\x11schema_generation\x18\x01 \x01(\fR\x10schemaGeneration\x124\n" +
	"\x06recipe\x18\x03 \x03(\v2\x1c.google.spanner.v1.KeyRecipeR\x06recipe\"\x81\x02\n" +
	"\vCacheUpdate\x12\x1f\n" +
	"\vdatabase_id\x18\x01 \x01(\x04R\n" +
	"databaseId\x12.\n" +
	"\x05range\x18\x02 \x03(\v2\x18.google.spanner.v1.RangeR\x05range\x12.\n" +
	"\x05group\x18\x03 \x03(\v2\x18.google.spanner.v1.GroupR\x05group\x121\n" +
	"\x06tablet\x18\x04 \x03(\v2\x19.google.spanner.v1.TabletR\x06tablet\x12>\n" +
